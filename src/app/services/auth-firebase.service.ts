...
import { AuthInterfaceResponse } from '../auth/interfaces/authInterface';
import { UsuarioModel } from '../auth/model/usuario-model';
...
//=======================Login user===============================================
  login(usuario:UsuarioModel){
    ...
    return this.http.post<AuthInterfaceResponse>(`${this.url}/accounts:signInWithPassword?key=${this.API_KEY}`, authData).
    pipe(map((resp :AuthInterfaceResponse)=>{
...
//===================================Registro Usuarios===========================================================
  register(usuario: UsuarioModel){
    ...
    //demos mandar una peticion post al url y le pasamos el usuario
    return this.http.post<AuthInterfaceResponse>(`${this.url}/accounts:signUp?key=${this.API_KEY}`, authData
    ).pipe(map((resp :AuthInterfaceResponse)=>{
      this.saveToken ( resp['idToken']);
      return resp;
    })
